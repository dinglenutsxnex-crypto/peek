...
object Architecture {
    ...
    fun getArchitecture(type: MachineType): IntArray {
        when (type) {
            ...
            MachineType.m68K, MachineType.m88K, MachineType.i860 -> return intArrayOf(
                CS_ARCH_X86,
                CS_MODE_32
            )
            MachineType.MIPS -> return intArrayOf(CS_ARCH_MIPS)
            MachineType.S370, MachineType.MIPS_RS3_LE -> return intArrayOf(CS_ARCH_MIPS)
            MachineType.PARISC, MachineType.VPP500, MachineType.SPARC32PLUS, MachineType.i960 -> return intArrayOf(
                CS_ARCH_X86,
                CS_MODE_32
            )
            ...
            MachineType.FAKE_ALPHA, MachineType.SH, MachineType.SPARCV9 -> return intArrayOf(
                CS_ARCH_SPARC
            )
            MachineType.TRICORE, MachineType.ARC, MachineType.H8_300, MachineType.H8_300H, MachineType.H8S, MachineType.H8_500, MachineType.IA_64 -> return intArrayOf(
                CS_ARCH_X86
            )
